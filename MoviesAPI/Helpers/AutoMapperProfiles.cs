...
namespace MoviesAPI.Helpers
{
    public class AutoMapperProfiles: Profile
    {
        public AutoMapperProfiles(GeometryFactory  geometryFactory)
        {
            ...
            CreateMap<MovieTheater, MovieTheaterDTO>().ForMember(x => x.Latitude, dto => dto.MapFrom(prop => prop.Location.Y))
        ...
        private List<MovieTheaterDTO> MapMovieTheatersMovies(Movie movie, MovieDTO movieDTO)
        {
            ...
            if (movie.MovieTheatersMovies != null)
            {
                ...
                {
                    result.Add(new MovieTheaterDTO() { Id = movieTheater.MovieTheaterId, Name = movieTheater.MovieTheater.Name,
                    Latitude = movieTheater.MovieTheater.Location.Y, Longitude = movieTheater.MovieTheater.Location.X});
                }
            }
